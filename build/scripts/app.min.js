...
/***/ function(module, exports) {
	...
	var D2tree = function () {
	    ...
	    D2tree.prototype.addLeaf = function (coords, value) {
	    ...
	    D2tree.prototype.findNearest = function (coords, radius) {
	        var self = this;
	        var tempLeader;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MarkerAggregator = function () {
	    ...
	    MarkerAggregator.prototype._createCompositeMarkers = function (coords, baseMarkerLink) {
	        ...
	        for (var j = this._baseZoom - this._zoomStep; j >= this._minZoom; j -= this._zoomStep) {
	            ...
	            if (!this._zoomLevels[j].compositeMarkersTree) {
	                // no composites yet
	                this._zoomLevels[j].compositeMarkersTree = new D2tree_ts_1.D2tree(coords, baseMarkerLink);
	            } else {}
	        }
	    };
	    ...
	    */
	    MarkerAggregator.prototype.addMarker = function (coords) {
	        ...
	        // create base marker
	        var marker = L.marker([localCoords.lat, localCoords.lng]);
	        marker.aId = ++this._id;
