	    ...
	    MarkerAggregator.prototype._createCompositeMarkers = function (coords, baseMarker) {
	        ...
	        for (var j = minZoom; j < baseZoom; j += zoomStep) {
	            ...
	            if (!zoomLevels[j].compositeMarkersTree) {
	                ...
	                // create c marker
	                compositeMarker = {
	                    marker: L.marker([coords.lat, coords.lng], { icon: compositeIcon }).bindPopup("1"),
	                    refs: [baseMarker]
	                };
	                ...
	                if (nearest.dist <= zoomLevels[j].windowSize) {
	                    ...
	                    }, 0) / compositeMarker.refs.length], { icon: compositeIcon }).bindPopup(compositeMarker.refs.length),
	                    // change popup
